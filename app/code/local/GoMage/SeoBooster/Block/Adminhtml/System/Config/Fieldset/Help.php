    ...
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    protected function _getHeaderHtml($element)
    {
        if (method_exists($this, '_getHeaderTitleHtml')) {
            ...
            $html .= '<button style="margin-right:25px; margin-top:-33px;  float: right;" onclick="window.open(\'http://wiki.gomage.com/display/seobooster/Home\')" class="scalable go" type="button" id="gsb_help"><span>' . $this->__('GoMage SEO Booster Wiki') . '</span></button>';
            ...
            $html .= '<button style="margin-right:25px;float: right;" onclick="window.open(\'http://wiki.gomage.com/display/seobooster/Home\')" class="scalable go" type="button" id="gsb_help"><span>' . $this->__('GoMage SEO Booster Wiki') . '</span></button>';
